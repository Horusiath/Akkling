...
module BidiFlow =
    ...
    let inline ofFlowsMat
        (flow1: #IGraph<FlowShape<_, _>, 'mat>)
        (matFn: 'mat -> 'mat2 -> 'mat3)
        (flow2: #IGraph<FlowShape<_, _>, 'mat2>)
        =
    ...
    let inline atopMat
        (bidi1: BidiFlow<_, _, _, _, 'mat2>)
        (matFn: 'mat -> 'mat2 -> 'mat3)
        (bidi2: BidiFlow<_, _, _, _, 'mat>)
        =
