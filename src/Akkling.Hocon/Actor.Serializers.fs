...
module Serializers =
    ...
    type SerializersBuilder<'T when 'T :> MarkerClasses.IField>() =
        ...
        member this.akka_cluster value = this.AkkaCluster([], value) |> this.Run
        ...
        member this.akka_cluster_client value =
            this.AkkaClusterClient([], value) |> this.Run
        ...
        member this.akka_containers value =
            this.AkkaContainers([], value) |> this.Run
        ...
        member this.akka_misc value = this.AkkaMisc([], value) |> this.Run
        ...
        member this.akka_persistence_message value =
            this.AkkaPersistenceMessage([], value) |> this.Run
        ...
        member this.akka_persistence_snapshot value =
            this.AkkaPersistenceSnapshot([], value) |> this.Run
        ...
        member this.akka_stream_ref value =
            this.AkkaStreamRef([], value) |> this.Run
        ...
        member this.akka_system_msg value =
            this.AkkaSystemMessage([], value) |> this.Run
        ...
        member this.bytes value = this.Bytes([], value) |> this.Run
        ...
        member this.daemon_create value =
            this.DaemonCreate([], value) |> this.Run
        ...
        member this.hyperion value = this.Hyperion([], value) |> this.Run
        ...
        member this.json value = this.Json([], value) |> this.Run
        ...
        member this.primitive value = this.Primitive([], value) |> this.Run
        ...
        member this.proto value = this.Proto([], value) |> this.Run

    let serializers =
        { new SerializersBuilder<Akka.Actor.Field>() with
            member _.Run(state: string list) =
                objExpr "serializers" 3 state |> Akka.Actor.Field }

    let serialization_settings =
        { new BaseBuilder<Akka.Actor.Field>() with
            member _.Run(state: string list) =
                objExpr "serialization-settings" 3 state |> Akka.Actor.Field }
